...
function fileUpload(node, inputName, inputData, app) {
    const srtWidget = node.widgets.find((w) => w.name === "file");
    let uploadWidget;
    /* 
...
ComfyWidgets.FILEUpload = fileUpload;

app.registerExtension({
	name: "Realisdance.UploadFILE",
